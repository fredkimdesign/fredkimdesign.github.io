  ...
  return (
    ...
    >
      <body className="bg-paper text-ink flex min-h-full flex-col">
        ...
        <header className="mx-auto flex w-full max-w-[76rem] items-baseline justify-between px-8 py-10">
        ...
        <footer className="mx-auto mt-40 w-full max-w-[76rem] px-8 text-sm text-faint">
